...
input_node_list = input_nodes.tolist()  # Convert to list
...
dataset = PygNodePropPredDataset(name='ogbn-papers100M')[0]

print("dataset", dataset)

hetero_data = HeteroData()
hetero_data['paper'].x = dataset.x
hetero_data['paper'].y = dataset.y
hetero_data['paper'].num_nodes = dataset.num_nodes
hetero_data['paper', 'cites', 'paper'].edge_index = dataset.edge_index
...
loader = NeighborLoader(
    ...
    input_nodes=('paper', input_node_set),
    num_workers=4,
