...
#SBATCH --output=logs/tweaked_neo4j_output.log          # Output log file
#SBATCH --error=logs/tweaked_neo4j_error.log            # Error log file
...
$SCRATCH/neo4j-community-5.21.0/bin/neo4j-admin database import full papers100m \
...
rsync -av --exclude=tmp $SCRATCH/neo4j-community-5.21.0/ /data/coml-intersection-joins/kebl7757/neo4j-community-5.21.0/