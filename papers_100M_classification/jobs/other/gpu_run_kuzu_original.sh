#!/bin/bash
#SBATCH --job-name=run_kuzu_sh             # Job name
...
#SBATCH --output=logs/gpu_run_kuzu_sh.log  # Output log file
#SBATCH --error=logs/gpu_run_kuzu_sh.log    # Error log file
