...
class GraphSampler:
    ...
    def get_tensor(self, attr: TensorAttr) -> Union[FeatureTensorType, None]:
        ...
        if attr_name == 'features':
            tensor = copy(self.node_features[node_type][hashed_indices])
            del self.node_features[node_type][hashed_indices]
            return tensor
        elif attr_name == 'label':
            tensor = copy(self.node_labels[node_type][hashed_indices])
            del self.node_labels[node_type][hashed_indices]
            return tensor
        elif attr_name == 'id':
            tensor = copy(self.node_ids[node_type][hashed_indices])
            del self.node_ids[node_type][hashed_indices]
            return tensor
