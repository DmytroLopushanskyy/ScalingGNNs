# Code below is directly sourced from https://github.com/pyg-team/pytorch_geometric/blob/master/examples/distributed/pyg/in-memory-alternative.py
import argparse
...
def train(
    ...
    def train_homo(batch):
        print("shape", batch.x.shape, batch.edge_index.shape)
        out = model(batch.x, batch.edge_index)[:batch.batch_size]
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--num_loader_threads',
        type=int,
        default=8,  # changed from 10 to 8
